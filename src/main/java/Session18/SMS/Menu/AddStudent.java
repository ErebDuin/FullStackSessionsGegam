...
public class AddStudent {
    ...
    public void execute() {
        ...
        Student student;
        if (type == 1) {
            student = new UndergradStudent(studentService.getStudents().size() + 1, null, null, null, 0, null);
            ...
            scanner.nextLine();
            GraduateStudent gradStudent = new GraduateStudent(studentService.getStudents().size() + 1, null, null, null, 0, null);
                                                                gradStudent.setEmail(email);
                                                                gradStudent.setFirstName(firstName);
                                                                gradStudent.setLastName(lastName);
                                                                gradStudent.setAge(age);
                                                                gradStudent.setMajor(major);
            try {
